        ...
        <ul class="nav-menu" id="js-nav-menu">
            ...
            <li class="active open">
                ...
                <a href="#" title="Application Intel" class=" " data-filter-tags="application intel">
                    ...
                    <span class="nav-link-text" data-i18n="nav.application_intel">Articles</span>
                </a>
                ...
                <ul>
                    ...
                    <li class="active">
                        ...
                        <a href="{{route('produits.index')}}" title="Produits" class=" "
                           data-filter-tags="Produits">

                            <span class="nav-link-text"
                                  data-i18n="nav.application_intel_analytics_dashboard">Produits</span>
                        </a>
                    ...
                    <li>
                        ...
                        <a href="{{route('fournisseurs.index')}}" title="Fournisseurs" class=" "
                           data-filter-tags="Les Founisseurs">
