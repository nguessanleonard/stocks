                                            ...
                                            <div class="position-relative">
                                                <div
                                                    ...
                                                    <input type="checkbox" class="custom-control-input"
                                                           id="start_interval">
                                                    <label class="custom-control-label" for="start_interval">Live
                                                        Update</label>
                                                </div>
                        ...
                        <div id="panel-2" class="panel" data-panel-fullscreen="false">
                            ...
                            <div class="panel-container show">
                                            ...
                                            <div class="h-100">
                                                        ...
                                                        <div class="d-flex mt-3 flex-wrap">
                                                            <div class="btn-group mr-1 mt-1" role="group"
                                                                ...
                                                                <button type="button"
                                                                        ...
                                                                        data-action="toggle">
                                                                            <span
                                                                                class="d-block text-truncate text-truncate-sm">
                                                ...
                                                <div class="d-flex flex-row px-3 pt-3 pb-2">
                                                    ...
                                                    <span class="status status-danger">
                                                                <span
                                                                    class="profile-image rounded-circle d-inline-block"
                                                                    style="background-image:url('{{asset("assets/img/demo/avatars/avatar-admin.png")}}')"></span>
                                                            </span>
                                                    <!-- profile photo end -->
                                                    <div class="ml-3">
                                                        <a href="javascript:void(0);" title="Lisa Hatchensen"
                                                           class="d-block fw-700 text-dark">Dr. Codex Lantern</a>
                                                        Thanks for the file! You guys go ahead, I have to call some of
                                                        my patients.
                                                    </div>
                                                </div>
                                                <!-- message reply end -->
                                ...
                                <div
                                    ...
                                    <div
                                        class="d-flex align-items-center py-2 px-2 bg-white border border-top-0 rounded-bottom bg-primary">
                                        ...
                                        <div
                                            ...
                                            <label class="custom-control-label" for="defaultInline1">Press
                                                <strong>ENTER</strong> to send</label>
                                        </div>
                                ...
                                <div class="panel-content jqvmap-bg-ocean">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h4 class="d-inline-block fw-300 m-0 text-muted fs-lg">
                                            ...
                                            <small class="js-jqvmap-country mb-0 fw-500 text-dark">United States of
                                                America - $3,760,125.00</small>
                                        </h4>
                                    </div>
                                </div>
                            </div>
